...
const Admissions = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      await axios.post(`${apiUrl}/api/admissions-form`, submitData, {
        headers: {
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-600 to-teal-600 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            Thank you for your interest in Mothers International Academy. We have
            received your application and will contact you soon.
          </p>
          <button
            onClick={() => {
